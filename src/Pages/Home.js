                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Rohan kaushal</b>
                      ...
                      <div className="about-social-icon text-center">
                        <ul className="about-social">
                          <li className="wow fadeIn" data-wow-delay=".4s">
                            <a
                              href="https://www.linkedin.com/in/rohan-kaushal-91bbba22a/"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".2s">
                            <a
                              href="https://github.com/rohankaushal123"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".6s">
                            <a
                              href="https://www.instagram.com/_.mooonnnn._/"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".8s">
                            <a
                              href="https://twitter.com/Rohank27"
                              target="newtab"
                            >
                              <i
                  ...
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <p>
                        ...
                        traffic the site can handle. In addition, I also work on website
                        functionality in Angular and React.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      <div className="main-title left-title text-left wow fadeIn">
                        <h3>Hello! This is Rohan kaushal</h3>
                        <div className="underline1 no-margin"></div>
                        <div className="underline2 no-margin"></div>
                      </div>
                      <p className="wow fadeIn">
                        I am a web developer from Punjab, India. I enjoy
                      ...
                      <a
                        ...
                        href="assets/cv/20075074_Rohan _Kaushal_Main.pdf"
                        target="_blank"
                      >
                        See Resume
                      </a>
                  ...
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".2s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          Completed my school life from Our Lady of fatima
                          convent School Patiala, Punjab.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="row main-row wow fadeIn">
                  <div className="col-md-12">
                    <div className="main-title text-center">
                      ...
                      <div className="underline2"></div>
                      <p>
                        I have worked in a company named Viithiisys Technology where I developed
                        Angular web applications and also I am upcoming Intern at Oracle.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-md-6 col-sm-12">
                    <div className="exp-details" data-wow-delay=".2s">
                      ...
                      <div className="exp-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          I did an internship at Viithiisys tech as a
                          Main tech team member.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6 col-sm-12">
                    <div className="exp-details" data-wow-delay=".2s">
                      ...
                      <div className="exp-main">
                        ...
                        <h4>Server Technology &amp; Developer</h4>
                        <h2>2023</h2>
                        <div className="underline1"></div>
                        <div className="underline2"></div>
                        <p>Upcoming Intern at Oracle in field of Server Technology. </p>
                      </div>
                    </div>
                  </div>
                </div>
                            ...
                            >
                              ...
                              <div className="carousel-inner">
                                <div className="active item">
                                  <blockquote>
                                    <p>
                                      “Rohan was a real pleasure to work with
                  ...
                  <div className="row contact-info-row text-center wow fadeIn">
                    ...
                    <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".4s">
                        ...
                        <h3>Email</h3>
                        <a
                          href="mailto:contact.rohankl2011@gmail.com"
                          style={{
                            color: "black",
                            textDecoration: "none",
                            fontSize: "17px",
